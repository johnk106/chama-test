...
urlpatterns = [
    ...
    path('download-individual-investments/<int:chama_id>/',views.download_individual_investments,name='download-individual-investments'),
    path('download-my-investments/<int:chama_id>/',views.download_my_investments,name='download-my-investments'),
