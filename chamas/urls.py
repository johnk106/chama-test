...
urlpatterns = [
    ...
    path('download-group-contributions-report/<int:chama_id>/',views.download_group_contributions_report,name='download-group-contributions-report'),
    path('download-member-contributions-report/<int:chama_id>/<int:member_id>/',views.download_member_contribution_report,name='download-member-contribution-report'),
